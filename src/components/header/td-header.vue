      ...
      <nav class="navbar navbar-expand navbar-light navbar-bg">
          ...
          <i class="hamburger align-self-center"></i>
              ...
              Mega menu
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="@/assets/_template/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle" alt="Ashley Briggs">
											</div>
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="@/assets/_template/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle" alt="Carl Jenkins">
											</div>
											<div class="col-10 ps-2">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="@/assets/_template/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle" alt="Stacie Hall">
											</div>
											<div class="col-10 ps-2">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="@/assets/_template/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle" alt="Bertha Martin">
											</div>
											<div class="col-10 ps-2">
                ...
                <img src="@/assets/_template/img/flags/us.png" alt="English">
              </a>
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
								<a class="dropdown-item" href="#">
                  <img src="@/assets/_template/img/flags/us.png" alt="English" width="20" class="align-middle me-1">
                  <span class="align-middle">English</span>
                </a>
								<a class="dropdown-item" href="#">
                  <img src="@/assets/_template/img/flags/es.png" alt="Spanish" width="20" class="align-middle me-1">
                  <span class="align-middle">Spanish</span>
                </a>
								<a class="dropdown-item" href="#">
                  <img src="@/assets/_template/img/flags/de.png" alt="German" width="20" class="align-middle me-1">
                  <span class="align-middle">German</span>
                </a>
								<a class="dropdown-item" href="#">
                  <img src="@/assets/_template/img/flags/nl.png" alt="Dutch" width="20" class="align-middle me-1">
                ...
                <img src="@/assets/_template/img/avatars/avatar.jpg" class="avatar img-fluid rounded-circle me-1" alt="Chris Wood"> <span class="text-dark">Solsbecks Beno</span>
              </a>
