  ...
  <div class="navbar-collapse collapse">
    <ul class="navbar-nav navbar-align">
          ...
          <div class="list-group">
            <a href="#" class="list-group-item">
              <div class="row g-0 align-items-center">
                <div class="col-2">
                  <img
                    src="@/assets/_template/img/avatars/avatar-5.jpg"
            ...
            <a href="#" class="list-group-item">
              <div class="row g-0 align-items-center">
                <div class="col-2">
                  <img
                    src="@/assets/_template/img/avatars/avatar-2.jpg"
                    class="avatar img-fluid rounded-circle"
                    alt="Carl Jenkins"
                  />
                </div>
            ...
            <a href="#" class="list-group-item">
              <div class="row g-0 align-items-center">
                <div class="col-2">
                  <img
                    src="@/assets/_template/img/avatars/avatar-4.jpg"
                    class="avatar img-fluid rounded-circle"
                    alt="Stacie Hall"
                  />
                </div>
            ...
            <a href="#" class="list-group-item">
              <div class="row g-0 align-items-center">
                <div class="col-2">
                  <img
                    src="@/assets/_template/img/avatars/avatar-3.jpg"
                    class="avatar img-fluid rounded-circle"
                    alt="Bertha Martin"
                  />
                </div>
        ...
        >
          <div class="position-relative">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="feather feather-bell-off align-middle"
            >
      ...
      <li class="nav-item dropdown">
        ...
        >
          <a class="dropdown-item" href="#">
            <img
              src="@/assets/_template/img/flags/us.png"
              alt="English"
              width="20"
          ...
          <a class="dropdown-item" href="#">
            <img
              src="@/assets/_template/img/flags/es.png"
              alt="Spanish"
              width="20"
              class="align-middle me-1"
            />
          ...
          <a class="dropdown-item" href="#">
            <img
              src="@/assets/_template/img/flags/de.png"
              alt="German"
              width="20"
              class="align-middle me-1"
            />
          ...
          <a class="dropdown-item" href="#">
            <img
              src="@/assets/_template/img/flags/nl.png"
              alt="Dutch"
              width="20"
              class="align-middle me-1"
            />
      ...
      <li class="nav-item dropdown">
        ...
        >
          <img
            src="@/assets/_template/img/avatars/avatar.jpg"
            class="avatar img-fluid rounded-circle me-1"
            alt="Chris Wood"
          />
          <span class="text-dark">Solsbecks Beno</span>
        </a>
